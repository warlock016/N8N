...
PRODUCTION_VPS_HOST=116.203.182.116  # Your VPS IP
STAGING_VPS_HOST=116.203.182.116     # Same or different VPS for staging
...
DEPLOYMENT_URL=https://n8n-prod.automat.it.com
```
